function [X, stats] = tvdn(Y,lambda,C,Bf,osiz,varargin)
%
...
%%Commented this out for better performance and added as input to the fxn
...
if DIFFS_3D
    ...
    % We could compute this in closed-form...
    %%Commented this out for better performance and added as inputs to the
    %%fxn
%     C2 = Cc(m,n,1,2);
